...
module.exports = {
    'en': {
        ...
        'systemTime.name': 'systemtime module',
        'systemTime.description': 'Read the time the system has been running since it started',

        'tjabKit.description': 'Taijing robot Controllers-B+ .',
        'TJRobot.description': 'TJ robot.',
        'tjabKitLineTraker.name': 'Line Tracker',
        'tjabKitLineTraker.description': 'Single line tracker module.',
        'tjabKitIrRemoteReceiver.name': 'Taijing IR Remote Receiver',
        'tjabKitIrRemoteReceiver.description': 'Receiving and decoding data in infrared carrier.',
        'tjabKit_SetServo.name': 'Digital servo ',
        'tjabKit_SetServo.description': 'Digital servo support for taijing Cntrollers-B.',
        'tjabKitLed.name': 'Led',
        'tjabKitLed.description': 'Single led module.',
        'tjabKitButton.name': 'Button',
        'tjabKitButton.description': 'Single button module.',
        'tjabKitColorSensor.name': 'Color Sensor',
        'tjabKitColorSensor.description': 'Color sensor module.',
        'tjabKitGrayscaleSensor.name': 'GrayscaleSensor Line Tracker',
        'tjabKitGrayscaleSensor.description': 'Single GrayscaleSensor line tracker module.',

        'tj2560GrayscaleSensor.name': 'GrayscaleSensor Line Tracker',
        'tj2560GrayscaleSensor.description': 'Single GrayscaleSensor line tracker module.',
    ...
    'zh-cn': {
        ...
        'ultrasonic.name': '超声波',
        'systemTime.name': '系统时间模块',
        'systemTime.description': '读取系统从开机到现在运行的时间',

        'tjabKit.description': '太敬机器人控制器B+。',
        'TJRobot.description': '太敬机器人。',
        'tjabKitLineTraker.name': '循迹传感器',
        'tjabKitLineTraker.description': '单路循迹传感器模块。',
        'tjabKitIrRemoteReceiver.name': '红外遥控收信',
        'tjabKitIrRemoteReceiver.description': '接收并解码红外载波数据。',
        'tjabKit_SetServo.name': '数码舵机 ',
        'tjabKit_SetServo.description': '控制器-B数码舵机。',
        'tjabKitLed.name': 'LED 模块',
        'tjabKitLed.description': 'LED 模块。',
        'tjabKitButton.name': '开关模块',
        'tjabKitButton.description': '单路开关模块。',
        'tjabKitColorSensor.name': '颜色传感器',
        'tjabKitColorSensor.description': '颜色传感器模块。',
        'tjabKitGrayscaleSensor.name': '灰度循迹传感器',
        'tjabKitGrayscaleSensor.description': '单路灰度循迹传感器模块。',

        'tj2560GrayscaleSensor.name': '灰度循迹传感器',
        'tj2560GrayscaleSensor.description': '单路灰度循迹传感器模块。',       
